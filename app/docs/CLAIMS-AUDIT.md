...
| "AI-powered" | Deterministic rules engine (ADR-0006) + a trained YOLO11n for road damage in `ai/` | 98 unit tests | **PARTIAL** — the diagnosis "AI" is a rules engine, labelled as such in the UI. A remote model is an env change away and none is configured. |
