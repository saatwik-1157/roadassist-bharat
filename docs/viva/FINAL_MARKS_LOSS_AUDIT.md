...
| 5 | "65 endpoints under `/v1`" | 61 are under `/v1`; 65 is the total including `/health` and two tile routes. Small, but a professor who counts will find it | Reworded in four documents | **FIXED** |
