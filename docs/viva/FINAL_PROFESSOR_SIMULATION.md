...
| 49 | Our test total? | 618 executed, 0 failures, six suites. |
...
| Implementation | 15 | **13–14** | 618 assertions, 6 real bugs found and fixed | Little | Show the row lock |
...
**4:30 — Testing.** "618 assertions across six suites, zero failures, run twice
...
3. Testing honesty — 618 assertions and six self-found bugs.
...
5. 618 assertions, six suites, zero failures — and that a seventh needs an account.
