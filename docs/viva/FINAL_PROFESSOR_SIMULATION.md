...
> against it on 2026-09-12 — 56 tables, 65 routes, 672 executed assertions.
...
| Implementation | 15 | **13–14** | 672 assertions, 6 real bugs found and fixed | Little | Show the row lock |
...
**4:30 — Testing.** "672 assertions across six suites, zero failures, run twice
...
3. Testing honesty — 672 assertions and six self-found bugs.
...
5. 672 assertions, six suites, zero failures — and that a seventh needs an account.
