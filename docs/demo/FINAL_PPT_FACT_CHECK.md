...
> checked term by term against the code on 2026-09-06.
...
| **Security** | Slide 17 | **TRUE** | *"74 attacks that must fail, plus 26 gateway checks."* Add: *"no independent penetration test."* |
...
| **626 assertions** | Slide 24 | **TRUE** *(was FALSE)* | Corrected from "600 across seven suites". Volunteer that a seventh suite needs a Razorpay account. |
