...
# ── 24 · TESTING ───────────────────────────────────────────────────────────
s = new_slide()
title_block(s, "662 assertions, all executed", eyebrow="TESTING",
...
txt(s, 0.85, 6.3, 11.6, 0.35,
    "662 assertions · 6 suites · 0 failures  •  56 tables · 65 routes · 10 ADRs  •  every claim on these slides is testable",
